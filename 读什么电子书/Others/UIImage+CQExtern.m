...
//    [bgPath addArcWithCenter:CGPointMake(size.width/2, size.height/2) radius:
//     size.width/2 startAngle:0 endAngle:2*M_PI clockwise:YES];
//    [[UIColor clearColor] setFill];
//    [bgPath fill];
    
    UIBezierPath *entityPath = [UIBezierPath bezierPath];
    entityPath.lineWidth = 2.0;
    [entityPath addArcWithCenter:CGPointMake(size.width/2, size.height/2) radius:
